...
from config.i3d_head import I3DHead
import logging
from config.logger import get_root_logger
...
# @BACKBONES.register_module(name='backbone')
class SwinTransformer3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.head = I3DHead(2, self.num_features)
